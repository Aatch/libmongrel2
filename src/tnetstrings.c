...
void tns_value_destroy(tns_value_t *value)
{
    ...
    switch(value->type) {
        ...
        case tns_tag_string:
            ...
            break;
        default:
            check(0, "Invalid type given: '%c'", value->type);
    }
  ...
  switch(type) {
    ...
    case tns_tag_bool:
        if(vallen == 4 && valstr[0] == 't') {
            ...
            check(0, "Not a tnetstring: invalid boolean literal.");
        }
        break;
    ...
    case tns_tag_list:
        ...
        break;
    default:
      check(0, "not a tnetstring: invalid type tag");
  }
...
tns_render_value(void *val, tns_outbuf *outbuf)
{
  ...
  switch(type) {
    ...
    case tns_tag_invalid:
      check(0, "invalid tns value, can't be NULL");
      break;
    default:
      check(0, "unknown type tag: '%c'", type);
  }
